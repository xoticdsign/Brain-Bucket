		...
		case "1":
			...
			for {
				...
				case "3":
					...
					go EditNote(&note_edit, &note_edit_content, edit_channel)
...
func EditNote(note_edit *string, note_edit_content *string, edit_channel chan bool) {

	note_edit_int, err0r := strconv.Atoi(*note_edit)
